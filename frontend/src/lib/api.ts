    ...
    try {
      ...
      return {
        data: {
          ...
          data: {
            topDomains: [
              { hostname: 'pay-tm-verify-account.net', riskLevel: 'CRITICAL', avgRiskScore: 95, reportCount: 18 },
              { hostname: 'tneb-bill-update-payment.xyz', riskLevel: 'HIGH', avgRiskScore: 90, reportCount: 14 },
              { hostname: 'google.com', riskLevel: 'LOW', avgRiskScore: 0, reportCount: 0 },
            ],
            recentReports: [],
            categoryStats: [
              { category: 'PHISHING', count: 42 },
              { category: 'FAKE_PAYMENT', count: 38 },
              { category: 'MALWARE', count: 19 },
              { category: 'IMPERSONATION', count: 25 },
            ],
